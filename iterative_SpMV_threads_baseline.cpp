//
// ============================================================================
// FROZEN BASELINE — kept only for benchmarking against the optimized version.
// This is the pre-optimization threaded code (mutex+condition_variable barrier,
// unpadded reduction slots). The actual deliverable is iterative_SpMV_threads.cpp
// (cache-line padding + std::barrier). Do not develop here; run_interleaved.sbatch
// builds both files so the two can be compared on the same machine without git.
// ============================================================================
//
